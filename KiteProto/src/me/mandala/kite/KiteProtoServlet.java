...
public class KiteProtoServlet extends BaseServlet {
	/*public void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		resp.setContentType("text/plain");
		resp.getWriter().println("Hello, world");
	}*/
	private static final Logger logger = Logger.getLogger(KiteProtoServlet.class.getCanonicalName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		logger.log(Level.INFO, "Obtaining kiteproto listing");
		/*resp.setContentType("text/plain");
		resp.getWriter().println("Hello, world");*/
		
		RequestDispatcher dispatcher = 
		       getServletContext().getRequestDispatcher("/Create-Mandala.html");
	...
	/**
	 * Insert the new kitesproto
	 */
	protected void doPut(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		logger.log(Level.INFO, "Creating KitesProto");
		...
		String categoryid = req.getParameter("m-category");
		KitesProto.createOrUpdateKitesProto(nameKey, description, kitesprotoid, categoryid);
	}
